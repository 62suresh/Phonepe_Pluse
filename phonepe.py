...
engine = create_engine('mysql+pymysql://root:admin123456@localhost:3306/phonepe_pulse')

# Establishing Python-MySQL Connection
mydb = pymysql.connect(host='localhost',user='root',password='admin123456',port=3306)
sql = mydb.cursor()
...
def aggregate_transaction():
    path = "C:/Users/NN/Desktop/Phonepe/pulse/data/aggregated/transaction/country/india/state"
...
def aggregate_user():
    path = "C:/Users/NN/Desktop/Phonepe/pulse/data/aggregated/user/country/india/state"
    agg_state = os.listdir(path)
...
def map_transaction():
    path = "C:/Users/NN/Desktop/Phonepe/pulse/data/map/transaction/hover/country/india/state"
    agg_state = os.listdir(path)
...
def map_user():
    path = "C:/Users/NN/Desktop/Phonepe/pulse/data/map/user/hover/country/india/state"
    agg_state = os.listdir(path)
...
def top_transaction():
    path = "C:/Users/NN/Desktop/Phonepe/pulse/data/top/transaction/country/india/state"
    agg_state = os.listdir(path)
...
def top_user():
    path =  "C:/Users/NN/Desktop/Phonepe/pulse/data/top/user/country/india/state"
    agg_state = os.listdir(path)
...
if select=="About Data":
    image1 = Image.open("C:/Users/NN/Desktop/Phonepe/PhonePe_Logo.svg.png")
